...
class Mission extends Model {
  ...
  toDict(includeSchema = false) {
    const data = {
      ...
      // snake_case aliases (consumed by team_console.js)
      mission_code: this.missionCode,
      input_text: this.inputText,
      output_format_hint: this.outputFormatHint,
    ...
    if (includeSchema) {
      ...
      // snake_case aliases
      data.valid_example = this.validExample;
      data.invalid_example = this.invalidExample;
      data.enum_constraints = this.getEnumConstraints();
    }
    return data;
  }
}
